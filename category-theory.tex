...
However, this is not true of all categories in general, but we can generalize
this idea to the notion of \textit{generalized elements}.

\todo{I don't understand this part. Generalized elements are like, interesting?}
